...
class TestAddContact(AddressBookAppTestCase):
    ...
    def test_add_and_cancel_contact(self):
        ...
        cancelButton = self.main_window.select_single("Button", objectName="reject")
        ...
        list_view = self.main_window.select_single("ContactListView", objectName="contactListView")
    ...
    def test_add_contact_without_name(self):
        ...
        acceptButton = self.main_window.select_single("Button", objectName="accept")

        """ Save button must be disabled """
        self.assertThat(acceptButton.enabled, Eventually(Equals(False)))
        
        firstNameField = self.main_window.select_single("TextInputDetail", objectName="firstName")
        lastNameField = self.main_window.select_single("TextInputDetail", objectName="lastName")
    ...
    def test_add_contact_with_name_and_phone(self):
        ...
        """ fill phone number """
        phone_number_0 = self.main_window.select_single("TextInputDetail", objectName="phoneNumber_0")
    ...
    def test_add_full_contact(self):
        ...
        """ fill email """
        email_0 = self.main_window.select_single("TextInputDetail", objectName="emailAddress_0")
        self.type_on_field(email_0, "holmes@sherlock.uk")

        """ fill im """
        im_0 = self.main_window.select_single("TextInputDetail", objectName="imUri_0")
        self.type_on_field(im_0, "sh@im.com.br")

        #TODO: scroll view to revel address

        """ fill address """
        street_0 = self.main_window.select_single("TextInputDetail", objectName="streetAddress_0")
        self.type_on_field(street_0, "221B Baker Street")
        locality_0 = self.main_window.select_single("TextInputDetail", objectName="localityAddress_0")
        self.type_on_field(locality_0, "West End")
        region_0 = self.main_window.select_single("TextInputDetail", objectName="regionAddress_0")
        self.type_on_field(region_0, "London")
        postcode_0 = self.main_window.select_single("TextInputDetail", objectName="postcodeAddress_0")
        self.type_on_field(postcode_0, "7777")
        country_0 = self.main_window.select_single("TextInputDetail", objectName="countryAddress_0")
