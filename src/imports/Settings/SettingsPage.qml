    ...
    Flickable {
        ...
        Column {
            ...
            ListItem.Standard {
                ...
                __foregroundColor: (activeFocus && application.usingKeyboard) ? Theme.palette.normal.foregroundText :
                                                                                Theme.palette.normal.foreground
                Rectangle {
                    color: UbuntuColors.orange
                    anchors.fill: parent
                    visible:addGoogleAccountItem.activeFocus && application.usingKeyboard
                    z: -1
                }
            }
            ListItem.Standard {
