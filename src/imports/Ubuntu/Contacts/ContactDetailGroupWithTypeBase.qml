...
ContactDetailGroupBase {
    ...
    typeModel: ListModel {
        ...
        Component.onCompleted: {
            append({"value": QtContacts.ContactDetail.ContextHome, "label": i18n.dtr("address-book-app", "Home"), "icon": null})
            append({"value": QtContacts.ContactDetail.ContextWork, "label": i18n.dtr("address-book-app", "Work"), "icon": null})
            append({"value": QtContacts.ContactDetail.ContextOther, "label": i18n.dtr("address-book-app", "Other"), "icon": null})
            loaded()
        }
    }
